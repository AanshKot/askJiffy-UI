...
// ChatSection can either take in an established chatMessage
// or it can render a pending chatMessage that is still being responded to 
...
export default function ChatSection({ chatMessage } : ChatSectionProps){
    ...
    return(
            <section id={`chatMessage-${chatMessage.id}`} className="w-[75%] flex flex-col gap-4 px-5 mb-4">
